...
describe("calculateValues", () => {
  ...
  describe("calcMean", () => {
    test("calculates mean of an item in an array and return a string to 1 decimal place", () => {
      const mean = calcMean(array, "value");
      expect(mean).toEqual("2.0");
    });

    test("returns string with number of decimal places passed as argument", () => {
  ...
  describe("calcMax", () => {
    test("calculates max of an item in an array and return a string to 1 decimal place", () => {
  ...
  describe("calcMin", () => {
    test("calculates min of an item in an array and return a string to 1 decimal place", () => {
